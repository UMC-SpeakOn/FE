...
const DateRangePickerBottomSheet = ({
  ...
  // ✅ open=false면 null 반환 → 열릴 때마다 마운트됨
  // ✅ 따라서 effect로 “초기화 setState” 할 필요가 없음
  ...
  // ✅ 바텀시트 오픈 시 바디 스크롤 막기 (이건 OK: 외부 시스템(DOM) 동기화)
  useEffect(() => {
    if (!open) return;
  ...
  return (
    <div className="fixed inset-0 z-[9999]">
      ...
      <div className="absolute left-0 right-0 bottom-0">
        <div className="mx-auto w-full max-w-[48rem] rounded-t-[2.0rem] bg-white shadow-[0_-8px_30px_rgba(0,0,0,0.18)]">
                  ...
                  >
                    {between && (
                      <div className="absolute inset-0 flex items-center justify-center">
                        <div className="h-[3.2rem] w-full bg-[#E8E3FF]" />
                      </div>
                    )}
          ...
          <div className="px-[2.0rem] pb-[1.6rem]">
            <button
              ...
              className={clsx(
                'w-full h-[4.6rem] rounded-[1.2rem] flex items-center justify-center gap-[0.8rem]',
